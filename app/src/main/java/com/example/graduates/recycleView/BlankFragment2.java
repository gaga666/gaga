...
import com.example.graduates.fragment.BaseFragment;
...
//        data.add(new Home("修改密码", R.drawable.me));
//        RecycleAdapter adapter = new RecycleAdapter(data,this.getContext(),R.layout.recycle_item, BR.Home);
